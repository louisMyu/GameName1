...
namespace GameName1
{
    class Rifle : Weapon
    {
        ...
        public override void Update(float elapsedTime, Vector2 playerCenter, float rotationAngle, int accuracy, int weaponLength, bool fireDown)
        {
            base.Update(elapsedTime, playerCenter, rotationAngle, accuracy, weaponLength, fireDown);
        ...
        public override bool CheckCollision(GameObject ob, out Vector2 hitAngle)
        {
        ...
        public override void DrawBlast(SpriteBatch _spriteBatch, Vector2 position, float rot)
        {
            ...
            if (m_SavedShotInfo.NumFrames > 0)
            {
                ...
                //{
                //    _spriteBatch.Draw(blast2, m_SavedShotInfo.Position, null, Color.White, m_SavedShotInfo.Rotation, new Vector2(0, blast.Height / 2), 1.0f, SpriteEffects.None, 0f);
                //}
